...
export const PlusIcon: React.FC<IconProps> = ({ width = 24, height = 24, color = 'currentColor', style }) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={2} style={style}>
...
export const HorseIcon: React.FC<IconProps> = ({ width = 24, height = 24, color = 'currentColor', style }) => (
...
export const DownloadIcon: React.FC<IconProps> = ({ width = 24, height = 24, color = 'currentColor', style }) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={2} style={style}>
